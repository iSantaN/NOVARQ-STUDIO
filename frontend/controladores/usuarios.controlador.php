			...
			if(preg_match('/^[a-zA-ZñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["regUsuario"]) &&
			   ...
			   preg_match('/^[a-zA-Z0-9]+$/', $_POST["regPassword"])){
				...
				if($respuesta == "ok"){
					...
					$mail->setFrom('novarq.arquitectura@gmail.com', 'NOVARQ STUDIO');

					$mail->addReplyTo('novarq.arquitectura@gmail.com', 'NOVARQ STUDIO');
					...
					$mail->msgHTML('<div style="width:100%; background:#eee; position:relative; font-family:sans-serif; padding-bottom:40px">
						...
						<center>
							...
							<img style="padding:20px; width:10%" src="http://www.novarq-studio.com/tienda/logo.png">
						...
						<div style="position:relative; margin:auto; width:600px; background:white; padding:20px">
							...
							<img style="padding:20px; width:15%" src="http://www.novarq-studio.com/tienda/icon-email.png">
					...
					if($respuesta2  == "ok"){
						...
						$mail->msgHTML('<div style="width:100%; background:#eee; position:relative; font-family:sans-serif; padding-bottom:40px">
								...
								<div style="position:relative; margin:auto; width:600px; background:white; padding:20px">
									...
									<img style="padding:20px; width:15%" src="http://www.novarq-studio.com/tienda/icon-pass.png">
			...
			preg_match('/^[^0-9][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[@][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,4}$/', $_POST["emailContactenos"])){
				...
				=============================================*/
					...
					$mail->msgHTML('
						...
						<center><img style="padding:20px; width:10%" src="http://www.novarq-studio.com/tienda/logo.png"></center>

						<div style="position:relative; margin:auto; width:600px; background:white; padding-bottom:20px">

							<center>

							<img style="padding-top:20px; width:15%" src="http://novarq-studio.com/tienda/icon-email.png">
